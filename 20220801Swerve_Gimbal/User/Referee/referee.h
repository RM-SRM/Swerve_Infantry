...
uint16_t reserved;
} ext_robot_commandTX_t;

extern void init_referee_struct_data(void);
extern void referee_data_solve(uint8_t *frame);
extern void get_chassis_power_and_buffer(fp32 *power, uint16_t *buffer);
extern void get_chassis_maxpower(uint16_t *maxpower);
extern uint8_t get_robot_HP(void);
extern uint8_t get_robot_id(void);
extern uint8_t get_robot_level(void);
extern void get_shoot_heat0_limit_and_heat0(uint16_t *heat0_limit, uint16_t *heat0);
extern void get_shoot_heat1_limit_and_heat1(uint16_t *heat1_limit, uint16_t *heat1);
extern void get_robot_shoot_speed_limit(uint16_t *shoot_speed_limit);
extern void get_robot_shoot_cooling(uint16_t *cooling_rate, uint16_t *cooling_limit, uint16_t *cooling_data_now);
extern float get_robot_shoot_speed(void);
