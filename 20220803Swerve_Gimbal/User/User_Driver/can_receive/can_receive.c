...
void CAN_CMD_Chassis(uint8_t max_power,uint8_t buffer,int16_t chassis_X,int16_t chassis_Y,int16_t chassis_Z)
{
	...
	TxData[0] = max_power;
	TxData[1] = buffer;
	TxData[2] = chassis_X >> 8;
	TxData[3] = chassis_X;
	TxData[4] = chassis_Y >> 8;
	TxData[5] = chassis_Y;
	TxData[6] = chassis_Z >> 8;
	TxData[7] = chassis_Z;
