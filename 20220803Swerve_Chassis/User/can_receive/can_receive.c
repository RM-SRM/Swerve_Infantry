...
uint8_t chassis_powermax;
int16_t chassis_buffer;
//supercap_measure_t supercap;
//需要Ecd闭环的电机
...
const uint8_t *get_Chassis_PowerMax_Point(void)
{
    return &chassis_powermax;
}

const int16_t *get_Chassis_Buffer_Point(void)
{

    return &chassis_buffer;
...
{
	chassis_powermax = aData[0];
	chassis_buffer = aData[1]*2;
